...
<video width="640" height="480" controls.</p>
            <a href="https://github.com/tuusuario/proyecto2" target="_blank">Ver en GitHub</a>
        </div>
        <div class="proyecto">
            <h3>Optimización de gastos de marketing para Showz</h3>
